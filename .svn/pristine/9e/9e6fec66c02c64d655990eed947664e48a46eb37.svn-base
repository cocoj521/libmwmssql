...
public:
   ...
   int  Query(const char* szSql, MSSQL_SQLTYPES_NSAMESPACE::SQLSTRTYPE nType=MSSQL_SQLTYPES_NSAMESPACE::SQLSTRTYPE_NORMAL, bool bNeedRetSet=true);
   bool Fetch(MSSQL_SQLVALUE_NSAMESPACE::SQLValueArray& arrValues, bool bFetchBLOB = true);
   void EndFetch();
protected:
   void GetFields();
